 ...
 */
public class HopScotchHashTest {

    HopScotchHashMap<MyInteger, MyString> map;
    ...
    public void testPutWithRegrow() {
        insertSomeElements(1000);
        assertEquals("put size wrong after regrowing", 1000, map.size());
        //map.dumpTables();
